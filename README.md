...
| **[Statistical Analysis and Predictive Modeling in Cricket](https://github.com/rohit-moholkar/msc-dissertation)** | MSc dissertation analyzing 225K+ ball-by-ball records across 950 IPL matches to evaluate batting, bowling, fielding, and team performance, then engineering match-state features and building an ML pipeline with one-hot encoding and logistic regression that achieved 81.16% test accuracy and 80.86% 5-fold cross-validation accuracy for win-probability prediction. |
