...
| Project | Overview |
|---|---|
| **[Data Technology Ecosystem Intelligence](https://github.com/rohit-moholkar/data-technology-ecosystem-intelligence)** | End-to-end Fabric solution ingesting 11K+ activity records across 9 technologies from GitHub, Stack Overflow, and Hacker News, implementing a medallion architecture with PySpark notebooks, Dataflow Gen2, and a SQL Warehouse to produce a 9-table Gold dimensional model and 5-page Power BI report. |
